...
BoostPackage _parseBoostPackage(String pkg) {
  switch (pkg.toUpperCase()) {
    case 'VIP': return BoostPackage.vip;
    case 'PREMIUM': return BoostPackage.premium;
    case 'STANDARD': return BoostPackage.standard;
    default: return BoostPackage.basic;
  }
}
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (event.boostPackage != null) ...[
                    BoostBadge(package: _parseBoostPackage(event.boostPackage!)),
